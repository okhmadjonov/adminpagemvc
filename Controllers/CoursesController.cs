...
namespace AdminPageMVC.Controllers
{
    public class CoursesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ImageUrl,Description,Price")] Course course)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ImageUrl,Description,Price")] Course course)
        {
            if (id != course.Id)
            {
                return NotFound();
